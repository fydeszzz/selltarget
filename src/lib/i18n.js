...
export const translations = {
  en: {
    ...
    feeMinNote: '* NT$20 minimum commission per trade; the multiplier has no effect when the amount is small.',
    ...
    settingsBugReportText: 'If you run into any issues, click the button above to contact the author.',
    githubButton: 'Github',
  ...
  zh: {
    ...
    feeMinNote: '* 每筆手續費最低 20 元，成交金額較小時折扣倍率不影響試算',
    buyFee: '手續費（買進）',
    sellFee: '手續費（賣出）',
    secTax: '證交稅（賣出）',
    netProfit: '淨獲利',
    ...
    languageLabel: '語言',
    marketLabel: '市場',
    nav: { calc: '賣點試算', fees: '手續費試算', settings: '設定' },
    ...
    settingsBugReportText: '若有問題可點擊上方按鈕聯繫作者',
